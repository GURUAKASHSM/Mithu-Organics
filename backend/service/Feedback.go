...
// 	id, err := ExtractCustomerID(feedback.Token, "")
// 	if err != nil {
...
// 	_, err = config.Product_Collection.InsertOne(context.Background(), FeedbackDB)
// 	if err != nil {
// 		log.Println(err)
...
// 	}
// 	_, err := config.Product_Collection.DeleteMany(context.Background(), combinedFilter)
// 	if err != nil {
// 		return 0
// 	}
// 	return 1
