...
func Router() *gin.Engine {
	...
	router.POST("/vailidateadmintoken",controller.ValidateAdminToken)
	...
	router.POST("/viewadmin", controller.ViewAdmin)
	router.POST("/blockorunblockadmin", controller.BlockorUnblockAdmin)
	router.POST("/listadminaudit", controller.ListAdminAudit)
	router.POST("/listdeveloperaudit", controller.ListDeveloperAudit)
